...
type Provider interface {
	...
	ControllerHydrationProcessors(ctx context.Context) (int, error)
	ControllerOperationProcessors(ctx context.Context) (int, error)
	ControllerStatusProcessors(ctx context.Context) (int, error)
	...
	NotificationsProcessorsCount(ctx context.Context) (int, error)
